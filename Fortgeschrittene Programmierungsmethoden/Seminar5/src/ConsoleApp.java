...
//        Repository<Student> studentRepo = new FileRepository<>("students.db");
    ...
    private static Repository<Student> createInMemoryStudentRepository() {
        ...
        IntStream.range(1, 6).forEach(i -> studentRepo.create(new Student(i, "Student" + i)));
        return studentRepo;
    }
    ...
    private static Repository<Course> createInMemoryCourseRepository() {
        ...
        courseRepo.create(new Course(1, "Course1", new Teacher(1, "Teacher1"), 25, 5));
        courseRepo.create(new Course(2, "Course2", new Teacher(1, "Teacher1"), 35, 2));
        courseRepo.create(new Course(3, "Course3", new Teacher(2, "Teacher2"), 35, 2));
        courseRepo.create(new Course(4, "Course4", new Teacher(2, "Teacher2"), 15, 4));
        courseRepo.create(new Course(5, "Course5", new Teacher(2, "Teacher2"), 65, 2));
