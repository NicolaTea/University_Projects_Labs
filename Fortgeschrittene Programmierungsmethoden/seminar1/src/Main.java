...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("1.1 add(1.3,0.9): "+matheAufgabe.add(x, y));
        System.out.println("1.2 sub(1.3,0.9): "+matheAufgabe.sub(x, y));
        System.out.println("1.3 mul(1.3,3): "+matheAufgabe.mul(x, 3));
        ...
        System.out.println("4. isPerfekt(6): "+ matheAufgabe.isPerfekt(6));
